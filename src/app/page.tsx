  ...
  return (
    <main>
          ...
          <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
            <div className="space-y-5 sm:space-y-6">
              ...
              <div className="flex flex-col gap-3 sm:flex-row">
                <Link
                  href="/produtos"
                  className="rounded-full bg-accent px-7 py-4 text-center text-sm font-bold uppercase tracking-[0.18em] text-surface-strong shadow-[0_18px_40px_rgba(137,252,0,0.28)] transition-transform hover:-translate-y-0.5"
                >
                  Ver catalogo
                </Link>
                <Link
                ...
                {productGrid.slice(0, 4).map((item) => (
                  ...
                  >
                    {item.imageSrc ? (
                      ...
                      <div className="flex aspect-[4/5] items-end bg-[linear-gradient(135deg,#f3f8f8_0%,#e4eeee_48%,#d8ff9e_100%)] p-4 text-surface-strong">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="flex items-end justify-between gap-3">
            <div>
              ...
              <h2 className="mt-2 text-2xl font-black uppercase leading-tight text-surface-strong sm:mt-3 sm:text-4xl sm:text-white">
                Catalogo direto para o cliente ver e comprar.
              </h2>
            </div>
            <Link
              href="/produtos"
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-3">
            {featuredProducts.map((product) => (
              <article
                key={product.name}
                className="overflow-hidden rounded-[1.8rem] border border-line bg-white shadow-[0_14px_32px_rgba(38,53,55,0.08)] sm:rounded-[2rem] sm:border-white/10 sm:bg-[#5b757e] sm:shadow-[0_14px_40px_rgba(19,38,59,0.12)]"
              >
                <div className="relative overflow-hidden p-5 text-surface-strong sm:h-56 sm:p-6 sm:text-white">
                  <div className={`absolute inset-0 bg-gradient-to-br ${product.palette} sm:opacity-100 opacity-15`} />
                  <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,rgba(137,252,0,0.14),transparent_32%)]" />
                  <div className="hero-grid absolute inset-0 opacity-0 sm:opacity-35" />
                  <div className="relative">
                    <p className="text-[11px] font-bold uppercase tracking-[0.18em] text-[#4f6b74] sm:text-xs sm:tracking-[0.2em] sm:text-white">
                      {product.category}
                    </p>
                    <h3 className="mt-3 text-2xl font-black uppercase leading-tight sm:max-w-[12rem] sm:text-3xl">
                      {product.name}
                    </h3>
                ...
                <div className="flex items-center justify-between border-t border-slate-100 px-5 py-4 sm:border-transparent sm:p-6">
                  <Link
                    href="/produtos"
                    className="text-xs font-bold uppercase tracking-[0.16em] text-surface-strong sm:hidden"
                  >
                    Ver catalogo
                  </Link>
                  <Link
      ...
      <section className="px-5 pb-14 pt-2 sm:px-8 lg:px-12">
        <div className="mx-auto max-w-6xl rounded-[2rem] bg-[linear-gradient(135deg,#e1ffb4_0%,#89fc00_48%,#66d81d_100%)] p-8 text-surface-strong shadow-[0_20px_60px_rgba(137,252,0,0.2)]">
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="flex flex-col gap-3 sm:flex-row lg:justify-end">
              ...
              <Link
                ...
                target="_blank"
                rel="noreferrer"
                className="rounded-full border border-surface-strong/15 bg-white/70 px-6 py-4 text-center text-sm font-bold uppercase tracking-[0.16em] text-surface-strong"
              >
                Comprar no WhatsApp
              </Link>
            </div>
