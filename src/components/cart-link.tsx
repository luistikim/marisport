...
export function CartLink() {
  ...
  return (
    ...
    >
      ...
      <span className="absolute -right-1 -top-1 inline-flex min-h-5 min-w-5 items-center justify-center rounded-full bg-accent px-1 text-[10px] font-black text-surface-strong">
        {itemCount}
      </span>
    </Link>
  );
